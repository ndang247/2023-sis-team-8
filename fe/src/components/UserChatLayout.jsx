  ...
  return (
    <>
      <div className="box-border m-auto flex flex-col min-h-screen">
        {prevApiResponse && prevSearchApiResponse && (
          <>
            <div className="rounded-lg bg-white p-3 shadow-md">
              <Response
                apiResponse={prevApiResponse}
                searchApiResponse={prevSearchApiResponse}
                isDisabled={true}
              />
            </div>
            <br></br>
        ...
        <div className="flex-grow flex flex-row items-center justify-end w-[100%] lg:mb-[1rem] lg:flex-col">
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              >
                <div className="text-white font-semibold text-[14px] leading-[16px] relative w-[150px] h-5">
                  AskUTS ChatBot
                </div>
              </button>
            </div>

...
export default function UserChatLayout() {
  return (
    <>
      <div className="box-border m-auto w-[1550px] h-[986px] relative">
        <div className="absolute inset-0">
          <div className="_2023-horizon-ui-ai-template-all-rights-reserved">
        ...
        <input
          className="absolute border border-[#e2e8f0] rounded-full w-[738px] h-[54px] overflow-hidden left-[305px] top-[825px] text-left text-[#718096] font-medium text-[14px] leading-[100%] pl-[20px]"
          placeholder="Send a message"
        ></input>

        <button
          className="absolute flex items-center justify-center w-[192px] h-[54px] rounded-full opacity-20 overflow-hidden left-[1053px] top-[825px] bg-gradient-to-r from-purple-500 to-indigo-500 shadow-lg"
          disabled
        >
        ...
        <div className="text-center font-medium text-[12px] leading-[100%] absolute left-1/2 transform -translate-x-1/2 top-[899px] w-[715px]">
          <span>
